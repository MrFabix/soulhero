...
$sql = "SELECT class_secondary_abilities.name, class_secondary_abilities.description, class.name AS name_class , class_secondary_abilities.cost, class_secondary_abilities.range_class, class_secondary_abilities.requisite,class_secondary_abilities.level
        FROM class_secondary_abilities 
        JOIN class ON class_secondary_abilities.fk_class = class.id 
        ORDER BY  name ASC ";
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Secondary Abilities</a></li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
...
<script>
    ...
    function filterLevel(level) {
        ...
        if (levelValue === '0') {
            ecommerceList.columns(6).search('').draw();
        } else {
            ecommerceList.columns(6).search(levelValue).draw();
        }
    }

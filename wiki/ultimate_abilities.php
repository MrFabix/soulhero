...
$sql = "SELECT class_ultimate.name, class_ultimate.description, class.name AS name_class , class_ultimate.cost, class_ultimate.range_class, class_ultimate.requisite
        FROM class_ultimate 
        JOIN class ON class_ultimate.fk_class = class.id 
        ORDER BY  name ASC ";
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Ultimate Abilities</a></li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->

...
$sql = "SELECT class_features.name, class_features.description, class_features.level, class.name AS name_class 
        FROM class_features 
        JOIN class ON class_features.fk_class = class.id 
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Class Feats</a></li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->

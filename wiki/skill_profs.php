...
$sql = "SELECT skill.*, statistics.name as statistic_name FROM skill JOIN statistics on skill.fk_statistic = statistics.id";
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Skill Profs</a></li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
